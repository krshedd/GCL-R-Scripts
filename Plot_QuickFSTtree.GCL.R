Plot_QuickFSTtree.GCL <- function(sillyvec, loci, inputfile, popnames = NULL, ncores = 4, groupvec = NULL, regioncol = NULL, cex = 1){
  ...
  colortree <- treeColor.GCL(tree = tree, currentnames = dimnames(pwfst)[[1]], treenames = popnames, groupvec = groupvec, regioncol = regioncol)
  
  PlotColorTree.GCL(color.tree = colortree, cex = cex)
