...
######################################################################################################################################################################################
  ...
  attributes=Reduce(rbind,lapply(collections,function(collection){get(paste0(collection,".gcl"),pos=1)$attributes[which(IDs[[collection]] == get(paste0(collection,".gcl"),pos=1)$attributes$FK_FISH_ID),,drop=FALSE]}))
