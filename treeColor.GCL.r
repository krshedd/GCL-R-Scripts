treeColor.GCL <- function(tree, currentnames, treenames, groupvec, regioncol, regionpch = NULL, write_nexus = FALSE, file = NULL){
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  if(write_nexus == TRUE ){
    ...
    NexusColorTree.GCL(tree = tree, file = file, groupvec = groupvec, group.col = regioncol, tip.labs = xx$tip.label , sep = "_")
