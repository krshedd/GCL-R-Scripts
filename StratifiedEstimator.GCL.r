...
#  my.priorname <- "Flat" 
# 
#  StratifiedEstimator=StratifiedEstimator.GCL(groupvec=my.groupvec, groupnames=my.groupnames, maindir=my.maindir, mixvec=my.mixvec, catchvec=my.catchvec, newname=my.newname, priorname=my.prior)
#
##################################################################################################################################################################################################
