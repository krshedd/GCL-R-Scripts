...
#    "files" A vector of xlsx or xls files in "dir" that you want to combine with the extension.
#    Example: files=c("CM31 QC 01 Import Results.xls","CM31 QC 02 Import Results.xls","CM31 QC Plate3 Imports.xls")
#    
