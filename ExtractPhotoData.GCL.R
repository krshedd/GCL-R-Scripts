ExtractPhotoData.GCL <- function(folder, data.file = NULL, plot.map = TRUE, map.file = NULL){
  ...
  # Example~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  # 
  # ExtractPhotoData.GCL(folder = "V:\\Library\\Media\\Photos\\2018 Trips\\Coho Baseline\\Glacier Cr", 
  #                       data.file = "PhotoData.csv", 
  #                       plot.map = TRUE, 
  #                       map.file = "PhotoData_map.html")
  #
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  if(!require("pacman")) install.packages("pacman"); library(pacman); p_load(tidyverse, leaflet, mapview, plotly, rgdal, gplots, exifr, sf, leafpop, htmlwidgets) # pacman::p_load loads required packages and installs them if they aren't in your library.
