create_hierfstat_data.GCL <- function(sillyvec, region = NULL, pop,loci, ncores  = 4){
  ...
  # 
  #   fstat.dat <- create_hierfstat_data.GCL(sillyvec = temporal_collections$silly, region = temporal_collections$region, pop = temporal_collections$pop, loci = loci81, ncores = 8)
  # 
