ASL_Import.GCL <- function(sillyvec, username, password, file = NULL, import.vars = TRUE){
  ...
  #
  #   ASL_Import.GCL(sillyvec = c("PPORTCH21", "PBARABCR21"), username = "awbarclay", password = password, import.vars = FALSE, file = "C:/Users/awbarclay/Documents/R/test_fish_table.csv") #This example includes silly code in output.
  #
  # Note~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  #
