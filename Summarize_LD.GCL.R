Summarize_LD.GCL <- function(LDresults, alpha = 0.05, prop_sign_pops = 0.5){
  
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  #
  #   This function takes the output from Test_LD.GCL, filters tests by the supplied significance level (alpha), 
  #   and makes a bar plot of the proportion of pops with significant test results for each locus pair.
  #
  # Inputs~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  #   
  #   LDresults - the output from Test_LD.GCL; a tibble with 3 variables: 
  #               1) Locus_pair, 
  #               2) Pop, 
  #               3) Pvalue
  #
  ...
  #  detach()
  #
  #  Summarize_LD.GCL(LDresults, alpha = 0.05, prop_sign_pops = 0.5)
  #   
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
