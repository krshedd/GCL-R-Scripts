gcl2Genepop.GCL <- function(sillyvec, loci, path, VialNums = TRUE, usat = FALSE, ncores = 4, npops = NULL){
  ...
  #           This argument is useful when running Linkage Disequilibrium tests in genepop using the gclTest_LD.GCL function so things finish faster. 
  # 
  # Outputs~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  #  gcl2Genepop.GCL(sillyvec = sillyvec, loci = loci, path = "GENEPOP/genepopfile.gen", VialNums = TRUE, usat = FALSE, ncores = 8, npops = NULL)
  #
  #  ### uSAT
  ...
  #  loci <- loci81
  #  detach()
  #  gcl2Genepop.GCL(sillyvec = sillyvec[1:36], loci = loci, path = "GENEPOP", VialNums = TRUE, usat = FALSE, ncores = 8, npops = 2)
  # 
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  start_time <- Sys.time()
