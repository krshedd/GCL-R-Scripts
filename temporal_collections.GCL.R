temporal_collections.GCL <- function(sillyvec, region = NULL, min.samps = 50, sep = "."){
  ...
  #     
  #   temporal_collections.GCL (sillyvec = sillyvec, region = region, min.samps = 50, sep = ".")  
  # 
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    
  if(!require("pacman")) install.packages("pacman"); library(pacman); pacman::p_load(tidyverse) 
