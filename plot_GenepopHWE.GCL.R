plot_GenepopHWE.GCL <- function(GenepopHWE_report, sillyvec = NULL, plot_type = "silly") {
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  # Outputs~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  #    Produces a plot of the results from ReadGenepopHWE.GCL. Specifically, displays p-value, overall p-value, by silly or by locus.
  #
  # Example~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  # 
  ...
  if (!is.null(sillyvec)) {
    ...
    if (n_sillys > n_matches) {
      stop(
        "GeneopHWE_report does not contain results for all sillys in sillyvec. Was sillyvec supplied for ReadGenepopHWE.GCL?"
      )
