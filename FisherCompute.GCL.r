FisherCompute.GCL <- function(freq, loci, prec = 4){
  ...
  # Inputs~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  #   
  #   freq - a tibble of allele freqencies produced by FreqPop.GCL() for the collections you want to test.
  #
  ...
  #   old2new_LocCtrl.GCL()
  #   old2new_gcl.GCL(sillyvec = c("KKILL05","KKILL06"), save_old = FALSE)
  #
  #   freq <- FreqPop.GCL(sillyvec = c("KKILL05","KKILL06"), loci = loci443)
  # 
  #   FisherCompute.GCL(freq = freq, loci = loci443, prec = 4)
  # 
  # Note~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  # This function is called on by FishersTest.GCL to do multiple tests at once.
  #
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
