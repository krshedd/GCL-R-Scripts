GenotypeReport.GCL <- function(project_name = NULL, sillyvec = NULL, loci = NULL, path, username, password, open.file = FALSE){  
  ...
  #
  # Geno_silly <- GenotypeReport.GCL(sillyvec = sillyvec, loci = NULL, path = "TestGenotypesReport_silly.csv", username = username, password = password, project_name = NULL)
  #
  # Geno_proj <- GenotypeReport.GCL(sillyvec = NULL, loci = NULL, path = "TestGenotypesReport_proj.csv", username = username, password = password, project_name = "S180", open.file = TRUE)
  #
  # Geno_P014_16 <- GenotypeReport.GCL(sillyvec = NULL, loci = NULL, path = "TestGenotypesReport_P014_16.csv", username = username, password = password, project_name = project_name)
  # 
  ...
  if(!require("pacman")) install.packages("pacman"); library(pacman); pacman::p_load(tidyverse, RJDBC, tools)  # Install packages, if not in library and then load them.
